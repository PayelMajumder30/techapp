                    ...
                    <div class="card-header">
                        <div class="row mb-3">
                            <div class="col-md-12 text-right">
                                <a href="{{ route('unit.create') }}" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Create</a>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                @forelse ($units as $index => $item)
                                    <tr>
                                        ...
                                        <td class="d-flex text-right">
                                            <div class="btn-group">
                                                <a href="{{route('unit.edit', ['id' => $item->id])}}" class="btn btn-sm btn-dark" data-toggle="tooltip" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form action="{{route('unit.delete', ['id' => $item->id])}}" method="POST" >
                                                    @csrf
                                                    @method('DELETE')
